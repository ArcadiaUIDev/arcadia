...
using Arcadia.Core.Accessibility;
using Xunit;
...
public class FocusTrapTests : Arcadia.Tests.Unit.ChartTestBase
{
    ...
    public void Renders_FocusSentinels_WhenActive()
    {
        ...
        var sentinels = cut.FindAll(".arcadia-focus-sentinel");
    ...
    public void Sentinels_AreVisuallyHidden()
    {
        ...
        var sentinel = cut.Find(".arcadia-focus-sentinel");
    ...
    public void HasActiveCssClass_WhenActive()
    {
        ...
        cut.Find(".arcadia-focus-trap").ClassList.Should().Contain("arcadia-focus-trap--active");
    }
    ...
    public void NoActiveCssClass_WhenInactive()
    {
        ...
        cut.Find(".arcadia-focus-trap").ClassList.Should().NotContain("arcadia-focus-trap--active");
    }
    ...
    public void Renders_WithCustomClass()
    {
        ...
        classes.Should().Contain("arcadia-focus-trap");
