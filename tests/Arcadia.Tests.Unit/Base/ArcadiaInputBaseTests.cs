...
/// <summary>
/// A minimal concrete input component for testing ArcadiaInputBase.
/// </summary>
public class TestInput : Arcadia.Core.Base.ArcadiaInputBase<string>
{
...
/// </summary>
public class TestNumericInput : Arcadia.Core.Base.ArcadiaInputBase<int>
{
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        builder.OpenElement(0, "input");
...
public class ArcadiaInputBaseTests : BunitContext
{
    ...
    [Fact]
    public void InheritsArcadiaComponentBase()
    {
        var cut = Render<TestInput>(parameters =>
