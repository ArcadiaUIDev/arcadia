...
public class TextFieldTests : BunitContext
{
    ...
    public void Renders_RequiredIndicator()
    {
        ...
        cut.Find(".helix-field__required").TextContent.Should().Be("*");
    ...
    public void Renders_HelperText()
    {
        ...
        cut.Find(".helix-field__helper").TextContent.Should().Be("Enter your full name");
    }
    ...
    public void Renders_Errors()
    {
        ...
        cut.Find(".helix-field__error").TextContent.Should().Be("Name is required");
        cut.Find(".helix-field--error").Should().NotBeNull();
