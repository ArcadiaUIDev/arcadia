...
public class LineChartApiTests : BunitContext
{
    ...
    public void Renders_Title()
    {
        ...
        cut.Find(".helix-chart__title").TextContent.Should().Be("Monthly Revenue");
    }
    ...
    public void Renders_HiddenDataTable()
    {
        ...
        var table = cut.Find("table.helix-sr-only");
        table.Should().NotBeNull();
        cut.FindAll("table.helix-sr-only tbody tr").Count.Should().Be(6);
    }
    ...
    public void Renders_MultiSeries_Legend()
    {
        ...
        var legendItems = cut.FindAll(".helix-chart__legend-item");
    ...
    public void HidesLegend_WhenShowLegendFalse()
    {
        ...
        cut.FindAll(".helix-chart__legend").Count.Should().Be(0);
    }
    ...
    public void Renders_DataPoints()
    {
        ...
        cut.FindAll("circle.helix-chart__point").Count.Should().Be(6);
    }
    ...
    public void HidesPoints_WhenShowPointsFalse()
    {
        ...
        cut.FindAll("circle.helix-chart__point").Count.Should().Be(0);
    }
    ...
    public void Renders_LinePath()
    {
        ...
        cut.FindAll("path.helix-chart__line").Count.Should().Be(1);
    }
    ...
    public void Renders_DashedLine()
    {
        ...
        var line = cut.Find("path.helix-chart__line");
    ...
    public void AnimationClasses_WhenAnimateOnLoad()
    {
        ...
        cut.FindAll(".helix-animate-line").Count.Should().BeGreaterThan(0);
    }
    ...
    public void NoAnimationClasses_WhenAnimateOff()
    {
        ...
        cut.FindAll(".helix-animate-line").Count.Should().Be(0);
        cut.FindAll(".helix-animate-point").Count.Should().Be(0);
    }
}
...
public class BarChartApiTests : BunitContext
{
    ...
    public void Renders_Bars()
    {
        ...
        cut.FindAll("rect.helix-chart__bar").Count.Should().Be(4);
    }
    ...
    public void Renders_GroupedBars_MultiSeries()
    {
        ...
        cut.FindAll("rect.helix-chart__bar").Count.Should().Be(8); // 4 data points × 2 series
    }
    ...
    public void Renders_StackedBars()
    {
        ...
        cut.FindAll("rect.helix-chart__bar").Count.Should().Be(8);
    }
    ...
    public void BarAnimation_WhenEnabled()
    {
        ...
        cut.FindAll(".helix-animate-bar").Count.Should().Be(4);
    }
    ...
    public void Renders_RoundedCorners()
    {
        ...
        var bar = cut.Find("rect.helix-chart__bar");
...
public class PieChartApiTests : BunitContext
{
    ...
    public void Renders_Slices()
    {
        ...
        cut.FindAll("path.helix-chart__pie-slice").Count.Should().Be(4);
    }
    ...
    public void Renders_PercentLabels_ByDefault()
    {
        ...
        var labels = cut.FindAll(".helix-chart__pie-label");
    ...
    public void HidesLabels_WhenFormatNone()
    {
        ...
        cut.FindAll(".helix-chart__pie-label").Count.Should().Be(0);
    }
    ...
    public void Renders_Legend()
    {
        ...
        cut.FindAll(".helix-chart__legend-item").Count.Should().Be(4);
    }
    ...
    public void Renders_AsDonut_WithInnerRadius()
    {
        ...
        var path = cut.Find("path.helix-chart__pie-slice");
    ...
    public void SmallSlices_HideLabels_BelowThreshold()
    {
        ...
        cut.FindAll(".helix-chart__pie-label").Count.Should().Be(1);
    }
    ...
    public void Renders_ScreenReaderTable()
    {
        ...
        cut.FindAll("table.helix-sr-only tbody tr").Count.Should().Be(4);
    }
    ...
    public void SliceAnimation_WhenEnabled()
    {
        ...
        cut.FindAll(".helix-animate-point").Count.Should().Be(4);
    }
}
...
public class ScatterChartApiTests : BunitContext
{
    ...
    public void Renders_Points()
    {
        ...
        cut.FindAll("circle.helix-chart__point").Count.Should().Be(20);
    }
    ...
    public void Renders_WithCustomPointSize()
    {
        ...
        var point = cut.Find("circle.helix-chart__point");
    ...
    public void PointAnimation_WithStagger()
    {
        ...
        var points = cut.FindAll(".helix-animate-point");
...
public class CandlestickChartApiTests : BunitContext
{
    ...
    public void Renders_CandlestickBodies()
    {
        ...
        cut.FindAll(".helix-candle__body").Count.Should().Be(5);
        cut.FindAll(".helix-candle__wick").Count.Should().Be(5);
    }
    ...
    public void Renders_UpAndDownColors()
    {
        ...
        var bodies = cut.FindAll(".helix-candle__body");
    ...
    public void CandleAnimation_WithStagger()
    {
        ...
        cut.FindAll(".helix-animate-candle").Count.Should().Be(10); // 5 wicks + 5 bodies
    }
    ...
    public void Renders_ScreenReaderTable()
    {
        ...
        cut.FindAll("table.helix-sr-only tbody tr").Count.Should().Be(5);
    }
}
