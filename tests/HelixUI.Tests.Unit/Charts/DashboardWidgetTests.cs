...
using HelixUI.Charts.Components.Dashboard;
using Xunit;
...
public class DeltaIndicatorTests : BunitContext
{
    ...
    public void Increase_ShowsUpArrow()
    {
        ...
        cut.Find(".helix-delta__arrow").TextContent.Should().Contain("↑");
        cut.Find(".helix-delta").ClassList.Should().Contain("helix-delta--increase");
    }
    ...
    public void Decrease_ShowsDownArrow()
    {
        ...
        cut.Find(".helix-delta__arrow").TextContent.Should().Contain("↓");
        cut.Find(".helix-delta").ClassList.Should().Contain("helix-delta--decrease");
    }
}
...
public class ProgressBarTests : BunitContext
{
    ...
    public void Renders_WithCorrectWidth()
    {
        ...
        cut.Find(".helix-progress__fill").GetAttribute("style").Should().Contain("width: 75%");
    }
    ...
    public void Renders_Label()
    {
        ...
        cut.Find(".helix-progress__label").TextContent.Should().Be("Storage");
    }
}
...
public class KpiCardTests : BunitContext
{
    ...
    public void Renders_TitleAndValue()
    {
        ...
        cut.Find(".helix-kpi__title").TextContent.Should().Be("Revenue");
        cut.Find(".helix-kpi__value").TextContent.Should().Be("$142K");
    }
    ...
    public void Renders_Delta()
    {
        ...
        cut.FindAll(".helix-delta").Should().HaveCount(1);
    }
    ...
    public void Renders_Footer()
    {
        ...
        cut.Find(".helix-kpi__footer").TextContent.Should().Be("vs last month");
    }
}
