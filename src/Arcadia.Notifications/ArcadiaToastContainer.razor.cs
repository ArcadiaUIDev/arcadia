...
/// </summary>
public partial class ArcadiaToastContainer : Core.Base.ArcadiaComponentBase, IDisposable
{
    [Inject]
    ...
    private string? CssClass => CssBuilder.Default("arcadia-toast-container")
        .AddClass($"arcadia-toast-container--{PositionClass}")
        .AddClass(Class)
        .Build();
