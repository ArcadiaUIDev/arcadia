...
/// </summary>
public partial class HelixGaugeChart : HelixUI.Core.Base.HelixComponentBase
{
    ...
    [Parameter] public string Color { get; set; } = "var(--helix-color-primary)";

    /// <summary>Background track color.</summary>
    [Parameter] public string TrackColor { get; set; } = "var(--helix-color-border, #e2e8f0)";
