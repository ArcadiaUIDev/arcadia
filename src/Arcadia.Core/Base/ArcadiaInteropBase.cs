...
/// <summary>
/// Base class for Arcadia Controls components that require JavaScript interop.
/// Handles lazy module loading and guaranteed disposal via <see cref="IAsyncDisposable"/>.
/// </summary>
public abstract class ArcadiaInteropBase : ArcadiaComponentBase, IAsyncDisposable
{
    /// <summary>
