...
/// </summary>
public partial class ArcadiaWizard : Core.Base.ArcadiaComponentBase
{
    private readonly List<ArcadiaWizardStep> _steps = new();
    private int _highestReached;

    /// <summary>
    /// Gets or sets the child content (ArcadiaWizardStep components).
    /// </summary>
    [Parameter]
    ...
    internal void RegisterStep(ArcadiaWizardStep step)
    {
    ...
    internal void UnregisterStep(ArcadiaWizardStep step)
    {
        _steps.Remove(step);
    }

    internal bool IsStepVisible(ArcadiaWizardStep step)
    {
