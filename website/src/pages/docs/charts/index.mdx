...
description: Blazor chart library with 16 chart types and 7 dashboard widgets. Native SVG rendering, zero JavaScript dependencies, WCAG 2.1 AA accessible.
---
...
A dashboard analytics toolkit for Blazor — 16 chart types and 7 pre-composed dashboard widgets. Native SVG rendering with zero JavaScript dependencies.
