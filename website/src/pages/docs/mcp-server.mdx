...
Generates complete Blazor Razor code for any of 12 currently-supported chart types (the MCP code-generation tool covers a curated subset of Arcadia's 20 chart types).
...
Returns an overview of the 12 currently-supported chart types (out of Arcadia's 20) with their components and use cases. No parameters needed.
