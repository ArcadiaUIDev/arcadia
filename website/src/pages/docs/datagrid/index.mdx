...
description: Blazor DataGrid with sorting, filtering, paging, virtual scrolling, grouping, inline editing, selection, and CSV export. Part of Arcadia Controls.
---

# DataGrid

A full-featured data grid for Blazor with sorting, filtering, paging, virtual scrolling, grouping, inline editing, row selection, column templates, and CSV export. Works in Server, WebAssembly, and Auto render modes.
